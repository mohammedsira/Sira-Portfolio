        ...
        <footer className="bg-gradient-to-b from-[#0a0a0f] to-[#12121a] text-gray-300 py-10 px-6 md:px-[8vw] relative">
            ...
            >
                ...
                <motion.div {...fadeUp(0.1)} className="flex-1 text-center md:text-left">
                    <h2 className="text-2xl font-semibold text-white mb-2">Mohammed sirajudeen</h2>
                ...
                >
                    <div className="flex gap-4">
                        <motion.a
                            href="https://github.com/mohammedsira"
                            target="_blank"
                            rel="noreferrer"
                        ...
                        <motion.a
                            href="www.linkedin.com/in/mohammed-sirajudeen0810"
                            target="_blank"
                            rel="noreferrer"
                            whileHover={{ scale: 1.2 }}
                            className="text-gray-400 hover:text-white transition-colors text-xl"
            ...
            >
                <p>
                    © {new Date().getFullYear()} <span className="text-white font-medium">Mohammed Sirajudeen </span>
                    All rights reserved.
                </p>
            </motion.div>
        </footer>
